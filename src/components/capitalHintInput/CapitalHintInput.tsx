...
const CapitalHintInput = defineComponent({
  ...
  setup() {
     ...
     * 当前键盘大写锁定是否打开
     */
    const isCapital: Ref<boolean> = ref(false);
    /**
    ...
    return (
      <div class={style["input-wrapper"]}>
        <input
          ...
          onFocusin={() => (this.inputFocus = true)}
          onFocusout={() => (this.inputFocus = false)}
          onKeyup={this.doKeyup}
          onPointerdown={this.doPointerDown}
        />
        <Transition name="bounce">
          <span
            v-show={this.inputFocus && this.isCapital}
